...
- Select New - This will ask you to select a file for loading.
- Select Go - This will bring you to the main IDA view, in a dormant state.
- Select Previous - This will load the previously loaded file.
...
Great you have loaded Minecraft in IDA! You can now start reversing.
